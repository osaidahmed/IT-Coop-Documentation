...
2.  **If you are working remotely:** You must first connect to the FortiClient VPN
    using your **new** password. Once the VPN connection is established, lock
    your computer (`Win + L`) and unlock it. This action forces the password
    change to sync with your computer's cached credentials.
