...
* **FortiClient Application:** The `FortiClient` application should be installed on
    your laptop and connected to the FSRA EMS. See [Cannot Connect to VPN] if you come across a problem with the VPN.
...
<Note>
At the very beginning, you will be able to connect to the VPN without the FortiToken app. But once you get the email from FortiAuthenticator, you will be required to put in the token. 
</Note>
