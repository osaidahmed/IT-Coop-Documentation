...
<Warning>
The following instructions for connecting to FSRAO-MOBILE are for reference only or extenuating circumstances. You should avoid connecting to this network or recommending it to users. Under certain conditions, using this network can cause account lockouts. See [Account Lockouts] for more information.
</Warning>
...
2.  Select `FSRAO-MOBILE` from the list of available networks.
...
2.  Select `FSRAO-MOBILE` from the list of "Other Networks".
